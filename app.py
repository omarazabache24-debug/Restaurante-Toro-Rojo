...
<div class="app {{'admin-mode' if session.get('rol') == 'ADMIN' else 'user-mode'}}">
  ...
  <main class="main">
    ...
    <div class="content">
      ...
      {{content|safe}}
      <div class="mobile-bottom"><a href="{{url_for('ventas')}}">🧾<br>Venta</a><a href="{{url_for('pedidos')}}">🚚<br>Pedido</a><a href="{{url_for('catalogo_admin')}}">🖼️<br>Catálogo</a><a href="{{url_for('cierre')}}">🔒<br>Cierre</a><a href="{{url_for('logout')}}">🚪<br>Salir</a></div>
    </div>
  </main>
</div>
{% else %}
