# -*- coding: utf-8 -*-
"""
COMEDOR PRIZE PRO FINAL - Mejorado desde app(53).py + ZIP Comedor 2.0.
Roles: admin = control total; comedor = Ventas/Consumos, Pedidos/Entregas y Cerrar Día.
...
<div class="main-layout">
    <aside class="sidebar fixed-prize-sidebar">
      ...
      <nav class="nav nav-pro">
        ...
        {% endif %}
        <a class="{{'on' if page=='consumos'}}" href="{{url_for('consumos')}}"><span class="nav-ico">🍽️</span>Ventas / Consumos</a>
        {% if session.get('role') == 'admin' %}
        <a class="{{'on' if page=='trabajadores'}}" href="{{url_for('trabajadores')}}"><span class="nav-ico">👥</span>Trabajadores</a>
        {% endif %}
        <a class="{{'on' if page=='entregas'}}" href="{{url_for('entregas')}}"><span class="nav-ico">🚚</span>Pedidos / Entregas <span class="pill nuevo">NUEVO</span></a>
        {% if session.get('role') == 'admin' %}
    ...
    <aside class="panel-right">
      ...
      <div class="card">
        ...
        <div class="quick">
          <a href="{{url_for('consumos')}}">🔹 Ventas / Registrar consumo</a>
          <a href="{{url_for('entregas')}}">🚚 Pedidos / Entregas</a>
...
# =========================
# ALIAS OPERATIVOS SOLICITADOS
# ventas = consumos / pedidos = entregas
# =========================
@app.route("/ventas")
@login_required
def ventas_alias():
