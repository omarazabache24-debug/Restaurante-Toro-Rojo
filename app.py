...
def login():
    ...
    <div class="login-page">
      <form class="login-card login-card-sin-promo" method="post">
        ...
        <style>
          .login-card-sin-promo::after, .login-card-sin-promo:after { content:none!important; display:none!important; height:0!important; min-height:0!important; padding:0!important; margin:0!important; background:transparent!important; }
          .login-card-sin-promo button { margin-bottom:0!important; }
        </style>
