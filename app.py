...
.login-card:after{content:"";white-space:pre;position:absolute;left:22px;right:22px;bottom:22px;min-height:88px;border-radius:18px;background:linear-gradient(120deg,var(--food-coral),#ff6b6b);color:#fff;font-weight:950;font-size:22px;display:flex;align-items:center;padding:18px;text-align:left;opacity:.96;}
...
def login():
    ...
    <div class="login-page">
      <form class="login-card" method="post">
        ...
        <p style="color:#ffd1d8;font-weight:800">Restaurante · Pizzería · Parrillas</p>
...
def pago_qr(pedido_id, metodo):
    ...
    yape_link = f"https://wa.me/?text={quote('Pago '+p['codigo']+' S/'+format(total_qr,'.2f'))}"
    monto_plain = format(total_qr, '.2f')
    # PRIVACIDAD + MONTO: en la pantalla de cobro no se muestra titular, nombre del QR, celular ni CCI.
    # El QR oficial de Yape/Plin no puede ser editado por el sistema para incrustar importe dinámico;
